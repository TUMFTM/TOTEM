...
%Getriebe 2-Stufen 2-Gang inkl. eTV
%Angaben in €
...
t_DG=200;   %Taktzeit Druckguss
t_EG=200;   %Taktzeit Entgratpresse
t_BAZ=600;  %Taktzeit Bearbeitung
...
t_FG=200;    %Taktzeit Formgebung
t_RH=140;    %Taktzeit Randschichthärten
t_BAZ=1000; %Taktzeit Bearbeitung
t_RE=600;   %Taktzeit Reinigung
t_UW=150;   %Taktzeit Verkettung
...
t_FG=400;   %Taktzeit Formgebung
t_WF=2800;  %Taktzeit Wälzfräsen
t_RM=1700;  %Taktzeit Räumen
t_RE=320;   %Taktzeit Reinigung
t_HA=200;   %Taktzeit Induktionshärten
t_SL=2250;  %Taktzeit Schleifen
...
t_ZR=2300;  %Taktzeit Zahnradmontage
t_LA=2200;  %Taktzeit Lagermontage
t_AM=2200;  %Taktzeit Anbauteilmontage
