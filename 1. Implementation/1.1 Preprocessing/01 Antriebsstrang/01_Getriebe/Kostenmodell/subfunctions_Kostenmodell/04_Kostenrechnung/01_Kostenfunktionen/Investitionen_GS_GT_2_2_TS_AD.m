%Definition der Investitionskosten für eine Getriebe-Großserienfertigung
%Getriebe 2-Stufen 2-Gang inkl. TS
%Angaben in €

%% Maschinenkosten (Einzelpreise)
...
t_EM=190; %Taktzeit der Getriebefertigung

%% Herstellung Lamellenträger

t_FG_LT = 180;
Anzahl_Maschinen_FG_LT=ceil(t_FG_LT/t_EM);
Formgebung_LT=Umformpresse*Anzahl_Maschinen_FG_LT;

Invest_LT=Formgebung_LT;
%% Gehäusefertigung

t_DG=100;   %Taktzeit Druckguss
t_EG=60;    %Taktzeit Entgratpresse
t_BAZ=180;  %Taktzeit Bearbeitung
t_RE=250;   %Taktzeit Reinigung
...
t_FG=90;    %Taktzeit Formgebung
t_RH=90;    %Taktzeit Randschichthärten
t_BAZ=1040; %Taktzeit Bearbeitung
t_RE=180;   %Taktzeit Reinigung
t_UW=100;   %Taktzeit Verkettung
...
t_FG=60;    %Taktzeit Formgebung
t_WF=1880;  %Taktzeit Wälzfräsen
t_RM=290;   %Taktzeit Räumen
t_RE=320;   %Taktzeit Reinigung
t_HA=100;   %Taktzeit Induktionshärten
t_SL=1000;  %Taktzeit Schleifen
...
t_ZR=160;   %Taktzeit Zahnradmontage
t_LA=350;   %Taktzeit Lagermontage
t_AM=420;   %Taktzeit Anbauteilmontage
t_ET=180;   %Taktzeit Endprüfung
...
Invest=Invest_LT+Invest_GH+Invest_W+Invest_ZR+Invest_EM;
...
clearvars Anbauteilmontage_EM Bandagierung_ST BAZ_BP BAZ_GH BAZ_W...
    ...
    Invest_LT t_FG_LT  Anzahl_Maschinen_FG_LT Formgebung_LT