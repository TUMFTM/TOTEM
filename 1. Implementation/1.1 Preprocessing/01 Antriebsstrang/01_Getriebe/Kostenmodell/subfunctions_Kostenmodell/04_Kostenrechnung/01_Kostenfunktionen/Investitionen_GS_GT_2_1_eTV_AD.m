...
%Getriebe 2-Stufen 1-Gang inkl. eTV
%Angaben in €
...
t_WF=2500;  %Taktzeit Wälzfräsen
t_RM=1500;  %Taktzeit Räumen
t_RE=320;   %Taktzeit Reinigung
t_HA=180;   %Taktzeit Induktionshärten
t_SL=2050;  %Taktzeit Schleifen
...
t_ZR=2100;  %Taktzeit Zahnradmontage
t_LA=2200;  %Taktzeit Lagermontage
t_AM=2000;  %Taktzeit Anbauteilmontage
