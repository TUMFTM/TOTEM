function [l_3,m_E,m_F,b_E,b_F,d_A_E,d_A_F,d_sh_E,d_sh_F,d_sh_4,d_1_E,d_1_F,Fehlerbit,Fehlercode,ID_E,ID_F] = set_bearings_achsnah( F_u_3,F_ax_3,F_rad_3,i_12,i_34,b_3,d_4,n_eck,values_B,Fehlerbit,Fehlercode,ueberlast,values_C,d_sh_4)
...
for k=1:u
    ...
    while 1
        ...
        l_3_3=(b_E_vec(k)/2)+b_3(k)+(b_F_vec(k)/2);
