function [ l_3,m_E,m_F,b_E,b_F,d_A_E,d_A_F,d_sh_E,d_sh_F,d_sh_4,d_1_E,d_1_F,Fehlerbit,Fehlercode,ID_E,ID_F] = set_bearings_diff_vec( F_u_3,F_ax_3,F_rad_3,l_3,s_3,d_kegel,i_12,i_34,b_3,d_4,n_eck,m_n,b_korb,values_B,Fehlerbit,Fehlercode,ueberlast,spalt,values_C)
...
%Wellendurchmesser der Abtriebswellen
d_sh_4=d_kegel-(5*m_n);
...
%Es handelt sich um eine nicht symmetrische Lagerung mit Kegelrollenlager.
%        _ 
%      _| |  
%---E-|_|4|--F--
%       |_| 
...
l_3_vec=l_3;
s_3_vec=s_3;
%Durchmesser für Lager ergeben sich aus den Außendurchmesser der Lager
i_12_vec=i_12;
i_34_vec=i_34;
b_3_vec=b_3;
...
for k=1:u
    ...
    while 1
        while 1
            ...
            F_Ez=(1/l_3)*(-F_u_3*((l_3/2)-s_3));
            F_Fz=-F_Ez-F_u_3;

            F_Ey=(1/l_3)*((F_ax_3*d_4/2)-(F_rad_3*((l_3/2)-s_3)));
            F_Fy=-F_rad_3-F_Ey;
        ...
        l_3_3=(b_E_vec(k)/2)+b_korb(k)+b_3+spalt+(b_F_vec(k)/2);
        s_3_3=l_3_3-(b_3/2)-(b_F_vec(k)/2);

        %Abfrage ob der Lagerabstand passt
        if(l_3_3<=l_3 && s_3_3<=s_3)
            s_3_vec(k)=s_3_3;
            l_3_vec(k)=l_3_3;
            break;
        else
