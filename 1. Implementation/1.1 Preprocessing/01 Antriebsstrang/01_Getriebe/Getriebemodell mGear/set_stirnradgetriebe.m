function [l_ges,h_ges,t_ges,m_ges,J_ges_antr,J_ges_abtr,Fehlerbit,Fehlercode,d_a1,d_a2,d_a3,d_a4,b_1,b_3,z_1,z_2,z_3,z_4,S_H_12,S_H_34,S_F_12,S_F_34,d_1,d_2,d_3,d_4,...
    alpha,zeta,d_motor,variante,gamma_1,gamma_2,gamma_3,gamma_1_B,gamma_2_B,d_1_g,d_2_g,d_4_g,gamma_3_B,m_A,m_B,m_C,m_D,m_E,m_F,i_12,i_34,...
    epsilon_beta_12,epsilon_beta_34,epsilon_alpha_12,epsilon_alpha_34,ID_A,ID_B,ID_C,ID_D,ID_E,ID_F,neig,...
    m_z1,m_z23,m_z4,m_korb,m_diff_stange,m_kegelraeder,m_geh,m_w1,m_w2,m_w4,a_12,a_34,alpha_wt_1,alpha_wt_2, ...
    m_torque,m_torque_cost, m_Lagersitz, M_nenn_em_Steuer, n_nenn_em_Steuer, n_max_em_Steuer, typ_em_Steuer, M_max_Steuer, ...
    MaxMotorTrqCurve_w, MaxMotorTrqCurve_M, MaxGeneratorTrqCurve_w, MaxGeneratorTrqCurve_M, MotorEffMap3D, MotorEffMap3D_w, ...
    MotorEffMap3D_M, GeneratorEffMap3D, GeneratorEffMap3D_w, GeneratorEffMap3D_M, z1_I, z2_II, z1_III, z2_III, z2_IV, zP_I_II, ...
    zP_III_IV, zVTV_1, zVTV_2, zVTV_3, zVTV_4,i12_I, i12_II, i12_III, i12_IV, iVTV_1, iVTV_2, eta12_I, eta12_II, eta12_III, eta12_IV, ...
    etaVTV_12, etaVTV_34, Jred_EM_Steuer, m_eTV, m_em_Steuer,Jred_eTV, Jx_eTV, Jy_eTV, Jz_eTV, Jx_em_Steuer, Jy_em_Steuer, Jz_em_Steuer, l_SEM,...
    x_eTV, y_eTV, z_eTV, x_SEM, y_SEM, z_SEM] = ...
    set_stirnradgetriebe(Maximaldrehmoment,Nenndrehmoment,Gesamtuebersetzung,Eckdrehzahl,Durchmesser_eMaschine, delta_M, differential,torque_vectoring,torque_splitter,Optimierung_Getriebe, Optimierung_Gesamttopologie, vzkonst, d_TIR, Spurweite)

%Finales Tool zur Bestimmung der Hauptabmessungen eines zweistufigen
%Stirnradgetriebes:
i_ges=Gesamtuebersetzung;
d_motor=Durchmesser_eMaschine;
[w,u]=size(i_ges);

%Größen setzen die sonst in GUI gesetzt werden
%16MnCr5
roh_inn=7.76/1000000;
sigma_fe=860;
sigma_hlim=1470;
%Neigungswinkel
neig_uebergabe=0;
...
Fehlercode=cell(1,u);
for k=1:u
    if(Nenndrehmoment(k)>400|| Nenndrehmoment(k)<30)
        Fehlerbit(1,k)=1;
...
while 1
    [l_ges,h_ges,t_ges,m_ges,J_ges_antr,J_ges_abtr,Fehlerbit,Fehlercode,d_a1,d_a2,d_a3,d_a4,b_1,b_3,z_1,z_2,z_3,z_4,S_H_12,S_H_34,S_F_12,S_F_34,d_1,d_2,d_3,d_4,alpha,zeta,d_motor,variante,gamma_1,gamma_2,gamma_3,gamma_1_B,gamma_2_B,d_1_g,d_2_g,d_4_g,gamma_3_B,m_A,m_B,m_C,m_D,m_E,m_F,i_12,i_34,epsilon_beta_12,epsilon_beta_34,epsilon_alpha_12,epsilon_alpha_34,ID_A,ID_B,ID_C,ID_D,ID_E,ID_F,neig,m_z1,m_z23,m_z4,m_korb,m_diff_stange,m_kegelraeder,m_geh,m_w1,m_w2,m_w4,alpha_wt_1,alpha_wt_2, m_torque,m_torque_cost, m_Lagersitz, M_nenn_em_Steuer, n_nenn_em_Steuer, n_max_em_Steuer, typ_em_Steuer, M_max_Steuer, MaxMotorTrqCurve_w, MaxMotorTrqCurve_M, MaxGeneratorTrqCurve_w, MaxGeneratorTrqCurve_M, MotorEffMap3D, MotorEffMap3D_w, MotorEffMap3D_M, GeneratorEffMap3D, GeneratorEffMap3D_w, GeneratorEffMap3D_M, z1_I, z2_II, z1_III, z2_III, z2_IV, zP_I_II, zP_III_IV, zVTV_1, zVTV_2, zVTV_3, zVTV_4,i12_I, i12_II, i12_III, i12_IV, iVTV_1, iVTV_2, eta12_I, eta12_II, eta12_III, eta12_IV, etaVTV_12, etaVTV_34, Jred_EM_Steuer, m_eTV, m_em_Steuer,Jred_eTV, Jx_eTV, Jy_eTV, Jz_eTV, Jx_em_Steuer, Jy_em_Steuer, Jz_em_Steuer, l_SEM, x_eTV, y_eTV, z_eTV, x_SEM, y_SEM, z_SEM, eTV_zaehlvariable] = ...
    ...
    err_S_H(:,i)=abs(S_H_12-S_H_34)';
    err_S_F(:,i)=abs(S_F_12-S_F_34)';
    i=i+1;
    i_12=i_12_uebergabe-(0.1*(i-1));
    i_34=i_ges./i_12;
    if(i>16)
        break;
    end  
...
for k=1:u
    ...
    for j=1:16
        if(min_err==err_sum(k,j))
            i_12(k)=i_12_uebergabe(k)-(0.1*(j-1));
        end
    end
end
i_34=i_ges./i_12;
...
for k=1:u
    ...
    elseif(strcmp(Optimierung_Getriebe(1,k),'Länge')==0 && strcmp(Optimierung_Getriebe(1,k),'Höhe')==0 && strcmp(Optimierung_Getriebe(1,k),'Masse')==0 && strcmp(Optimierung_Getriebe(1,k),'Manual')==0)
        Fehlerbit(k)=1;
        Optimierung_Getriebe(1,k)={'Länge'};
        Fehlercode(1,k)={'Uebergabeparameter ungueltig: Die Getriebeoptimierung kann nicht ausgeführt werden. Das Getriebe wurde nach der Länge optimiert'};
    elseif(Eckdrehzahl(1,k)>8000)
        Eckdrehzahl(1,k)=3500;
    end
end
eTV_zaehlvariable=1; % um eTV nur beim letzten Aufruf von set_gear_1_2_vec zu berechnen(Rechenzeitoptimierung)
   [l_ges,h_ges,t_ges,m_ges,J_ges_antr,J_ges_abtr,Fehlerbit,Fehlercode,d_a1,d_a2,d_a3,d_a4,b_1,b_3,z_1,z_2,z_3,z_4,S_H_12,S_H_34,S_F_12,S_F_34,d_1,d_2,d_3,d_4,alpha,zeta,d_motor,variante,gamma_1,gamma_2,gamma_3,gamma_1_B,gamma_2_B,d_1_g,d_2_g,d_4_g,gamma_3_B,m_A,m_B,m_C,m_D,m_E,m_F,i_12,i_34,epsilon_beta_12,epsilon_beta_34,epsilon_alpha_12,epsilon_alpha_34,ID_A,ID_B,ID_C,ID_D,ID_E,ID_F,neig,m_z1,m_z23,m_z4,m_korb,m_diff_stange,m_kegelraeder,m_geh,m_w1,m_w2,m_w4,alpha_wt_1,alpha_wt_2, m_torque,m_torque_cost, m_Lagersitz, M_nenn_em_Steuer, n_nenn_em_Steuer, n_max_em_Steuer, typ_em_Steuer, M_max_Steuer, MaxMotorTrqCurve_w, MaxMotorTrqCurve_M, MaxGeneratorTrqCurve_w, MaxGeneratorTrqCurve_M, MotorEffMap3D, MotorEffMap3D_w, MotorEffMap3D_M, GeneratorEffMap3D, GeneratorEffMap3D_w, GeneratorEffMap3D_M, z1_I, z2_II, z1_III, z2_III, z2_IV, zP_I_II, zP_III_IV, zVTV_1, zVTV_2, zVTV_3, zVTV_4,i12_I, i12_II, i12_III, i12_IV, iVTV_1, iVTV_2, eta12_I, eta12_II, eta12_III, eta12_IV, etaVTV_12, etaVTV_34, Jred_EM_Steuer, m_eTV, m_em_Steuer,Jred_eTV, Jx_eTV, Jy_eTV, Jz_eTV, Jx_em_Steuer, Jy_em_Steuer, Jz_em_Steuer, l_SEM, x_eTV, y_eTV, z_eTV, x_SEM, y_SEM, z_SEM, eTV_zaehlvariable] = ...
       set_gear_1_2_vec(Maximaldrehmoment,Nenndrehmoment,i_12,i_34,Eckdrehzahl,Optimierung_Getriebe, Optimierung_Gesamttopologie,Fehlerbit,Fehlercode,values_A,values_B,values_C,d_motor,neig_uebergabe,sigma_fe,sigma_hlim,roh_inn, delta_M, differential,torque_vectoring,torque_splitter, vzkonst, Gesamtuebersetzung, eTV_zaehlvariable, d_TIR, Spurweite);
...
ID_E=ID_E{1,1};
ID_F=ID_F{1,1};
%Achsabstände für GUI berechnene
a_12=(d_1+d_2)./2;
a_34=(d_3+d_4)./2;
